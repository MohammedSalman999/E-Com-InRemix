...
// Server-side data fetching (Only HDHMR category woods)
...
export default function HDHMRWoods() {
  ...
  useEffect(() => {
    setPanelContent(selectedWood ? <WoodDetails wood={selectedWood} /> : <p>No HDHMR materials available.</p>)
  }, [selectedWood, setPanelContent])

  return (
    <div className="w-full p-4">
      <h1 className="text-xl font-bold mb-4">HDHMR Boards</h1>
