  ...
  return (
    <Card className="shadow-lg">
      ...
      <CardContent>
        ...
        {item.poles && <p className="text-gray-600">Poles: {item.poles}</p>}
...
export default function MCBItems() {
  ...
  useEffect(() => {
    setPanelContent(selectedItem ? <ItemDetails item={selectedItem} /> : <p>No MCB items available.</p>)
  }, [selectedItem, setPanelContent])

  return (
    <div className="w-full p-4">
      <h1 className="text-xl font-bold mb-4">MCBs</h1>
