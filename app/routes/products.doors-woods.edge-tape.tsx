...
// Server-side data fetching (Only EDGE_TAPE category woods)
...
export default function EdgeTapeWoods() {
  ...
  useEffect(() => {
    setPanelContent(selectedWood ? <WoodDetails wood={selectedWood} /> : <p>No edge tape materials available.</p>)
  }, [selectedWood, setPanelContent])

  return (
    <div className="w-full p-4">
      <h1 className="text-xl font-bold mb-4">Edge Tape Materials</h1>
        ...
        {woods.map((wood) => (
          ...
          >
            ...
            <CardContent>
              ...
              {wood.thickness && <p className="text-gray-500">Thickness: {wood.thickness}</p>}
            </CardContent>
          </button>
        ))}
      </div>
