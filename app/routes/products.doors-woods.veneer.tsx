...
// Server-side data fetching (Only VENEER category woods)
...
export default function VeneerWoods() {
  ...
  useEffect(() => {
    setPanelContent(selectedWood ? <WoodDetails wood={selectedWood} /> : <p>No veneer materials available.</p>)
  }, [selectedWood, setPanelContent])

  return (
    <div className="w-full p-4">
      <h1 className="text-xl font-bold mb-4">Veneers</h1>
