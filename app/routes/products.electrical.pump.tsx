  ...
  return (
    <Card className="shadow-lg">
      ...
      <CardContent>
        ...
        {item.consumption && <p className="text-gray-600">Consumption: {item.consumption}</p>}
...
export default function PumpItems() {
  ...
  useEffect(() => {
    setPanelContent(selectedItem ? <ItemDetails item={selectedItem} /> : <p>No pump items available.</p>)
  }, [selectedItem, setPanelContent])

  return (
    <div className="w-full p-4">
      <h1 className="text-xl font-bold mb-4">Pumps</h1>
