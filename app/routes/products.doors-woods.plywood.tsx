...
// Server-side data fetching (Only PLYWOOD category woods)
...
export default function PlywoodWoods() {
  ...
  useEffect(() => {
    setPanelContent(selectedWood ? <WoodDetails wood={selectedWood} /> : <p>No plywood materials available.</p>)
  }, [selectedWood, setPanelContent])

  return (
    <div className="w-full p-4">
      <h1 className="text-xl font-bold mb-4">Plywood</h1>
